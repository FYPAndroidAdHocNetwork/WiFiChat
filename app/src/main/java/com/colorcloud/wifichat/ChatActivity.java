...
public class ChatActivity extends Activity {
	...
	public void initFragment(String initMsg) {
		...
		catch(Exception e) { Toast.makeText(this, "Init fragment Failed",  Toast.LENGTH_SHORT).show(); }
    }
	...
	public void onDestroy() {
		...
		catch(Exception e) { Toast.makeText(this, "On Destroy Failed",  Toast.LENGTH_SHORT).show(); }
	}
	...
	private void testWithListViewWeight() {
		...
		catch(Exception e) { Toast.makeText(this, "List View Failed",  Toast.LENGTH_SHORT).show(); }
	}
    ...
    final class ChatMessageAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
			...
			catch(Exception e) { Toast.makeText(this.getContext(), "Get View Failed",  Toast.LENGTH_SHORT).show(); }
            return view;
		}
    }
    ...
    protected void registerActivityToService(boolean register){
    	...
    	catch(Exception e) { Toast.makeText(this, "Register Activity Failed",  Toast.LENGTH_SHORT).show(); }
    }
    ...
    public void pushOutMessage(String jsonstring) {
    	...
    	catch(Exception e) { Toast.makeText(this, "Push Out Msg Failed",  Toast.LENGTH_SHORT).show(); }
    }
    ...
    public void showMessage(String msg){
    	...
    	catch(Exception e) { Toast.makeText(this, "Show Msg Failed",  Toast.LENGTH_SHORT).show(); }
    }
}
